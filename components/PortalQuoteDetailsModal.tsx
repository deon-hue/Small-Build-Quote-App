        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
          ...
          {quote.scope && (
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--ink)', lineHeight: 2.2, letterSpacing: '0.2px', wordSpacing: '0.05em', padding: '14px 16px', background: '#fafaf8', border: '1px solid var(--border)', borderRadius: 8, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                {quote.scope}
              </div>
            </div>
          )}

...
export function AppProvider({ children }: { children: ReactNode }) {
    ...
    async function load() {
      ...
      if (clientsRes.data) {
        setClients(clientsRes.data.map(r => ({
          ...
          clientType: (['supplier', 'subcontractor'].includes(r.client_type) ? r.client_type : 'client') as 'client' | 'supplier' | 'subcontractor',
  ...
  const addClient = useCallback(async (c: Omit<Client, 'id'>) => {
    ...
    setClients(prev => [...prev, {
      ...
      clientType: (['supplier', 'subcontractor'].includes(data.client_type) ? data.client_type : 'client') as 'client' | 'supplier' | 'subcontractor',

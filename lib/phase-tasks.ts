...
const externalSubphases: PhaseSubphase[] = [
  ...
  },
  {
    id: 'ext-turfing',
    phase: 'External Works & Landscaping',
    name: 'Turfing & Soft Landscaping',
    markupPct: 20,
    tasks: [
      t('ext-turf-ground-prep',     'Prepare ground for turfing',            'm²',  50,   3.50,  0,     0,    0,    0,  'Rotovate/hand dig, rake to level, remove debris'),
      t('ext-turf-topsoil-spread',  'Supply and spread topsoil (100mm)',     'm²',  50,   1.50,  4.50,  0,    0,    0,  'Screened topsoil supply & spread to 100mm depth'),
      t('ext-turf-lay',             'Supply and lay turf',                   'm²',  50,   3.50,  5.50,  0,    0,    0,  'Rolawn or similar quality lawn turf, inc. 5% waste'),
      t('ext-turf-strip',           'Remove existing lawn',                  'm²',  50,   2.50,  0,     0,    0,    0,  'Strip existing turf by hand or turf cutter'),
      t('ext-turf-waste',           'Waste disposal (skip)',                 'nr',   1,   80,    0,     0,    0,  310,  'Skip hire and loading for arisings / stripped turf'),
      t('ext-turf-fertiliser',      'Supply and apply fertiliser',           'm²',  50,   0.50,  0.80,  0,    0,    0,  'Granular pre-turf or pre-seed fertiliser application'),
      t('ext-turf-seed',            'Supply and seed lawn',                  'm²', 100,   1.50,  0.80,  0,    0,    0,  'Ryegrass/fescue domestic mix, hand or machine sow'),
      t('ext-ag-supply-lay',        'Supply and install artificial grass',   'm²',  50,  12.00, 25.00,  0,    0,    0,  'Quality artificial grass supply & lay inc. 5% waste'),
      t('ext-ag-mot',               'Supply and compact MOT Type 1',         'm³',   5,   8.00, 28.00,  8.00, 0,    0,  'MOT Type 1 sub-base supply, spread and compact'),
      t('ext-ag-sand',              'Supply and screed sharp sand/grano dust','m³',  2,   12.00,35.00,  0,    0,    0,  'Sharp sand or grano dust screeded to level'),
      t('ext-ag-membrane',          'Supply and install weed membrane',      'm²',  50,   1.50,  1.20,  0,    0,    0,  'Geotextile weed control membrane with 10% lap allowance'),
    ],
  },
  {
...
export function matchPhaseTasksFromScope(
  ...
  const KEYWORDS: [string[], string, string][] = [
    ...
    [['turf','lawn','new lawn','returf','replace lawn','grass lawn'], 'ext-soft-landscaping', 'ext-turf'],
    [['turfing','soft landscaping','cultivated turf','lay turf'],  'ext-turfing',          'ext-turf-lay'],
    [['artificial grass','astro turf','fake grass'],               'ext-turfing',          'ext-ag-supply-lay'],
    [['seeded lawn','grass seed','seed lawn'],                      'ext-turfing',          'ext-turf-seed'],
    // Prelims

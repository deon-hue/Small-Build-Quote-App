...
export const JOB_TEMPLATES: Record<string, TemplatePhaseData[]> = {
  ...
  // ─── Rear Extension (10 main phases, 18 sub-phases) ──────────────────────────
  'Rear Extension': [
    tp('Phase 1 – Site Setup & Preparation','Preliminaries',            800,400,600,0,300,
    ...
    tp('Phase 2 – Groundworks & Foundations','Groundworks',              2200,0,1800,0,0,
    ...
    tp('Phase 2 – Groundworks & Foundations','Drainage',                 900,1200,300,0,0,
      ...
      'Mini excavator'),
    tp('Phase 2 – Groundworks & Foundations','Substructure',             2000,4000,600,0,0,
    ...
    tp('Phase 3 – Structural Shell','Superstructure',           2800,3200,200,0,0,
    ...
    tp('Phase 3 – Structural Shell','Structural Steels',        600,2200,400,0,0,
    ...
    tp('Phase 4 – Roof Construction','Roof Structure & Covering',2400,4000,300,0,0,
    ...
    tp('Phase 7 – Internal Construction','Plastering',               1800,700,350,0,0,
    ...
    tp('Phase 7 – Internal Construction','Screed & Floor Build-Up',  500,1200,150,0,0,
    ...
    tp('Phase 8 – Second Fix & Finishes','Second Fix',               1800,1600,0,0,0,
    ...
    tp('Phase 9 – Flooring & Decoration','Kitchen & Client Items',   1200,5500,0,0,0,
    ...
    tp('Phase 9 – Flooring & Decoration','Decoration',               800,350,0,0,0,
      'Decorator — mist coat and two finish coats throughout',
      'Mist coat, emulsion, gloss, filler, tape, caulk'),
    tp('Phase 10 – External Works & Completion','External Works',           1200,1800,400,0,0,
    ...
    tp('Phase 10 – External Works & Completion','Completion & Handover',    400,100,0,0,300,
